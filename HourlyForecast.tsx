...
function NationalAlertSummary({ alerts, onOpenForecast }: { alerts: NationwideAlert[]; onOpenForecast: (hazard: HazardKind) => void }) {
    ...
    <div className="nationwide-summary">
      ...
      <div className="nationwide-summary__items">
        {active.map((alert) => {
          ...
          return (
            <button key={alert.hazard} type="button" style={{ "--stage": meta.color } as CSSProperties} onClick={() => onOpenForecast(alert.hazard)}>
...
function WeatherFocus({ reading, hourly, nationwideAlerts, onOpenSafety, onOpenForecast }: { reading: Reading; hourly: HourlyReading[]; nationwideAlerts: NationwideAlert[]; onOpenSafety: () => void; onOpenForecast: (hazard: HazardKind) => void }) {
  ...
  return (
    <div className="weather-focus">
      ...
      <NationalAlertSummary alerts={nationwideAlerts} onOpenForecast={onOpenForecast} />
